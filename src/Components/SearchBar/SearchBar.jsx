      ...
      <div className="relative flex items-center w-full h-12 rounded-lg shadow-lg bg-white overflow-hidden">
        ...
        {searchTerm && (
          <button
            ...
            className="absolute right-4 top-1/2 transform -translate-y-1/2 cursor-pointer bg-gradient-to-r from-sky-500 to-indigo-500 text-[16px] rounded-lg font-semibold text-white px-8 py-2"
          >
            Clear
          </button>
        )}
